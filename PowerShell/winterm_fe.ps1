    ...
    while (-not $quitFlag) {
        ...
        for ($i = 0; $i -lt $Items.Count; $i++) {
            ...
            elseif ($item.PSIsContainer) {
                ...
                elseif ($item.Extension -eq ".exe" -or $item.Extension -eq ".bat" -or $item.Extension -eq ".ini") {
                    Write-Host "     $folderName" -ForegroundColor White
                }
                ...
                elseif ($item.Extension -eq ".lnk") {
                    Write-Host "    󱞬 $folderName" -ForegroundColor darkyellow
                }
                ...
                elseif ($item.Extension -eq ".exe" -or $item.Extension -eq ".bat" -or $item.Extension -eq ".ini" -or $item.Extension -eq ".msi") {
                    Write-Host "     $folderName" -ForegroundColor White
                }
